...
const CustomExpirationInput: React.FC<CustomExpirationInputProps> = ({ optionInputValue, placeholder, onChange, selectedOption, dateInputRef }) => {
    ...
    useEffect(() => {
        if (dateInputRef.current) {
            ...
            } else if (dateInputRef.current.classList.contains("show") || dateInputRef.current.classList.contains("hide")) {
